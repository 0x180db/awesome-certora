# Awesome Certora [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

A curated list of useful resources, tools, guides, and patterns for working with [Certora Prover](https://www.certora.com/). This list aims to support developers and auditors in using Certora effectively for formal verification of smart contracts.
